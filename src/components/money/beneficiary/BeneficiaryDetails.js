...
import './BeneficiciaryDetails.css'
    ...
    return(
      <div className="beneficiary__details">
        ...
        <form action="" className="beneficiary__details--form">
          <div>
            <input type="text" name="beneficiary__details--name" id="" className="beneficiary__details--input" placeholder="Enter name of the recipient"/>
          </div>
          <div className="beneficiary__input--label">Date of birth</div>
          <div className="beneficiary__dob--container">
            <input type="number" placeholder="01" className="beneficiary__details--input-1"/>
            <Select
              style={{ width: "100%" }}
            ...
            <input type="number" name="year" id="year" className="beneficiary__details--input-2"/>
          </div>
          ...
          <input type="text" placeholder="21 Downing street, London" className="beneficiary__details--input"/>
          <div className="beneficiary__input--label">City</div>
          <input type="text" className="" placeholder="London" className="beneficiary__details--input"/>
          <div className="beneficiary__input--label">Postal code</div>
          <input type="text" className="" placeholder="E1234" className="beneficiary__details--input"/>
          <div>
            <Link to="/confirm" className="beneficiary__details--btn btn btn-block text-center">Proceed</Link>
          </div>
        </form>
      </div>
    )
