...
import './BillsTransactionDetails.css'

class BillsTransactionalDetails extends React.Component {
  state = {
    ...
    return (
      <div>
        <div className="main__bg--container">
          <Header />
          <Transaction toggleConfirmation={this.toggleConfirmationModal}
          />
        </div>
        <MainFooter />
...
const Transaction = ({ toggleConfirmation }) => {
  return (
    <div className="transaction">
      ...
      <ul className="transaction__list transaction__list--one">
        ...
        <li className="transaction__list--flex">
          <span className="transaction__label">You are paying:</span>
        ...
        <li className="transaction__list--flex">
          <span className="transaction__label">You get</span>
      ...
      <ul className="transaction__list">
        ...
        <li className="transaction__list--flex">
          <span className="transaction__label">Beneficiary Bank</span>
          <span className="transaction__value">Guaranty Trust Bank PLC</span>
        </li>
        <li className="transaction__list--flex">
          <span className="transaction__label">Account</span>
          <span className="transaction__value">0123456</span>
        </li>
      </ul>
...
export default BillsTransactionalDetails