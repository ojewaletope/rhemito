...
import "./BillsConfirm.css";
import { buttonStyle } from "../../../App";
import { Select } from "antd";
const Option = Select.Option;

class BillsConfirm extends React.Component {
  handleChange = value => {
    console.log(value);
  };
  render() {
      ...
      <React.Fragment>
        <div className="main__background">
          ...
          <div className="confirm__flex">
            ...
            <h4 className="confirm__header">Who are you paying the bil for</h4>
            ...
            <div className="confirm__name--details">
              <h4 className="confirm__header">Beneficiary's Bills Operator</h4>
              <p className="confirm__text">IKEDC</p>
            </div>
            <div className="confirm__name--details">
            ...
            <Link to="/billstransactiondetails">
